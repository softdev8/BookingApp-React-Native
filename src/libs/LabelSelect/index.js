        ...
        {enable && !readOnly && enableAddBtn &&
          <View>
            <AwesomeButton
              states={{
                default: {
                  text: <Text>{buttonTitle || 'Select'}</Text>,
                  backgroundStyle: {
...
class ModalItem extends Component {
  ...
  constructor (props) {
    super(props);
    const { selected, data, toggleSelect } = props;
    ...
    return (
      <TouchableHighlight
        ...
        <View style={Styles.modalItem}>
          ...
          <View style={[Styles.outerRect, this.isSelected ? Styles.enableCircle : {}, customStyle.outerCircle || {}]}>
